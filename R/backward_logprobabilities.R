...
#'
#' @description Calculate matrix of backward log-probabilities for a given data set and parameters in a HMM. Essentially just a wrapper for the true function written in C++. Useful for avoiding underflow (by using the log-exp-sum-trick) when the HMM is large.
#'
...
#'
#' @return A matrix (m x n) of backward log-probabilities.
#' @export
#'
#' @examples TODO
